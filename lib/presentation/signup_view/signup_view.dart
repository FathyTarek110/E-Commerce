...
import 'package:e_commerce/business/signup_cubit/sign_up_cubit.dart';
...
import '../resources/reusable_comp/reusable_comp.dart';
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                myTextFormField(context: context,
                                    validate: (value){
                                      if(value != cubit.passwordTextEditingController.value ){
                                ...
                                ConditionalBuilder(
                                  ...
                                  builder:(_)=>buildMyButton(context,'Log In',(){
                                    if(cubit.formKey.currentState!.validate()){
                                      cubit.userSignUp(name: cubit.nameTextEditingController.text,phone: cubit.phoneTextEditingController.text,email: cubit.emailTextEditingController.text, password: cubit.passwordTextEditingController.text);
                                    }
                                  }) ,
