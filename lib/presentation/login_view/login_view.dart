...
import 'package:e_commerce/business/login_cubit/login_cubit.dart';
...
import 'package:e_commerce/presentation/resources/reusable_comp/reusable_comp.dart';
                          ...
                          ConditionalBuilder(
                            ...
                            builder:(_)=>buildMyButton(context,'Log In',(){
                              if(cubit.formKey.currentState!.validate()){
                                cubit.userLogin(email: cubit.emailTextEditingController.text, password: cubit.passwordTextEditingController.text);
                              }
                            }) ,
